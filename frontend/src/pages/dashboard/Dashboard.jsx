...
const Dashboard = () => {
    ...
    return (
        <>
            {/* Welcome banner */}
            <div className="bg-purple-600 rounded-lg p-6 text-white mb-2">
                <h2 className="text-2xl font-bold">Welcome back, Anagha!</h2>
                <p className="text-purple-200 mt-1">Here's what's happening with your bookstore today.</p>
            </div>
            ...
            <section className="bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Monthly Orders & Revenue</div>
                <div className="p-4">
                    <RevenueChart />
                </div>
            </section>
